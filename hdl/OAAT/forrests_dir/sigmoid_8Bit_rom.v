...
//
//      Instance Name:              sigmoid_8Bit_rom
//      Words:                      256
//      Bits:                       8
//      Mux:                        8
//      Drive:                      6
...
//      Test Muxes                  Off
//
//      Creation Date:  Wed Dec  2 13:04:59 2020
//      Version: 	r0p0-00eac0
//
...
`celldefine
`ifdef POWER_PINS
module sigmoid_8Bit_rom (Q, CLK, CEN, A, EMA, VSS, VDD);
`else
module sigmoid_8Bit_rom (Q, CLK, CEN, A, EMA);
`endif
...
`endif
  ...
  initial begin
    $readmemb("/home/mtennant/Projects/GRNN_Questa_test1/sigmoid_8Bit_rom_verilog.rcf", mem );
  end
