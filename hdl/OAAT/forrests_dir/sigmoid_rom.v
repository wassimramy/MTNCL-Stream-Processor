...
//      Test Muxes                  Off
//
//      Creation Date:  Thu Feb 27 12:47:55 2020
//      Version: 	r0p0-00eac0
//
...
`celldefine
`ifdef POWER_PINS
module sigmoid_rom (Q, CLK, CEN, A, EMA, VSS, VDD);
`else
module sigmoid_rom (Q, CLK, CEN, A, EMA);
`endif
...
`endif
  ...
  initial begin
    $readmemb("/home/mtennant/Projects/GRNN_Questa/sigmoid_rom_verilog.rcf", mem );
  end
...
`endif
  ...
  reg NOT_CLK_MINH, NOT_CLK_MINL, NOT_CLK_PER, NOT_EMA0, NOT_EMA1, NOT_EMA2;
  reg clk0_int;
  reg CREN_legal;
  initial CREN_legal = 1'b1;
