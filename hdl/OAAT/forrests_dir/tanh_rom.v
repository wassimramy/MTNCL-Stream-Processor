...
//      Test Muxes                  Off
//
//      Creation Date:  Thu Feb 27 12:48:28 2020
//      Version: 	r0p0-00eac0
//
...
`celldefine
`ifdef POWER_PINS
module tanh_rom (Q, CLK, CEN, A, EMA, VSS, VDD);
`else
module tanh_rom (Q, CLK, CEN, A, EMA);
`endif
...
`endif
  ...
  initial begin
    $readmemb("/home/mtennant/Projects/GRNN_Questa/tanh_rom_verilog.rcf", mem );
  end
