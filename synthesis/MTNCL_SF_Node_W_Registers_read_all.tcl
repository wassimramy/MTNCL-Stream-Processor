...
set ASYNC_PATH	"../../hdl/async/"
set HDL_PATH	"../../hdl/"
set OAAT_PATH	"../../hdl/OAAT/"
set CORES_PATH	"../../hdl/individual_cores/"
set SU_PATH	"../../hdl/storage_units/"
set CU_PATH	"../../hdl/control_unit/"
...
#set RTL_SOURCE_FILES "$RTL_SOURCE_FILES $SU_PATH"
#append RTL_SOURCE_FILES "sf_address_generator.vhd"
set RTL_SOURCE_FILES "$RTL_SOURCE_FILES $SU_PATH"
...
#set RTL_SOURCE_FILES "$RTL_SOURCE_FILES $CORES_PATH"
#append RTL_SOURCE_FILES "MTNCL_SF_Core_w_reg_sram.vhd"
#set RTL_SOURCE_FILES "$RTL_SOURCE_FILES $CORES_PATH"
#append RTL_SOURCE_FILES "MTNCL_SF_Core_Address_Gen_w_MUX.vhd"

#set RTL_SOURCE_FILES "$RTL_SOURCE_FILES $CORES_PATH"
#append RTL_SOURCE_FILES "MTNCL_SF_Core_Data_Loader.vhd"

#set RTL_SOURCE_FILES "$RTL_SOURCE_FILES $CORES_PATH"
#append RTL_SOURCE_FILES "MTNCL_SF_Core_Top_Level.vhd"
#Sourcing the image equalization core's designs
#set RTL_SOURCE_FILES "$RTL_SOURCE_FILES $CORES_PATH"
#append RTL_SOURCE_FILES "MTNCL_Shade_Counter.vhd"
#set RTL_SOURCE_FILES "$RTL_SOURCE_FILES $CORES_PATH"
#append RTL_SOURCE_FILES "MTNCL_Shade_Calculator.vhd"
#set RTL_SOURCE_FILES "$RTL_SOURCE_FILES $CORES_PATH"
#append RTL_SOURCE_FILES "MTNCL_Image_Reconstructor.vhd"
#set RTL_SOURCE_FILES "$RTL_SOURCE_FILES $CORES_PATH"
#append RTL_SOURCE_FILES "MTNCL_Histogram_Equalization.vhd"
#Sourcing the control unit's designs
#set RTL_SOURCE_FILES "$RTL_SOURCE_FILES $CU_PATH"
#append RTL_SOURCE_FILES "MTNCL_Control_Unit.vhd"
#set RTL_SOURCE_FILES "$RTL_SOURCE_FILES $CU_PATH"
#append RTL_SOURCE_FILES "MTNCL_CU_W_image_store_load.vhd"
