...
//      Test Muxes                  Off
//
//      Creation Date:  Fri Sep 25 16:36:09 2020
//      Version: 	r0p0-00eac0
//
...
`celldefine
`ifdef POWER_PINS
module sram2176x16 (Q, CLK, CEN, WEN, A, D, EMA, RETN, VSSE, VDDPE, VDDCE);
`else
module sram2176x16 (Q, CLK, CEN, WEN, A, D, EMA, RETN);
`endif

  parameter BITS = 16;
  parameter WORDS = 2176;
  parameter MUX = 8;
  parameter MEM_WIDTH = 128; // redun block size 8, 64 on left, 64 on right
  parameter MEM_HEIGHT = 272;
...
`endif
  ...
  begin
    if (RETN_int === 1'bx) begin
      ...
      Q_int = {data_out[120], data_out[112], data_out[104], data_out[96], data_out[88],
...
`endif
  ...
  reg NOT_D10, NOT_D11, NOT_D12, NOT_D13, NOT_D14, NOT_D15, NOT_D2, NOT_D3, NOT_D4;
  reg NOT_D5, NOT_D6, NOT_D7, NOT_D8, NOT_D9, NOT_EMA0, NOT_EMA1, NOT_EMA2, NOT_RETN;
  reg NOT_WEN;
  reg clk0_int;
  reg CREN_legal;
  initial CREN_legal = 1'b1;
 ...
 wire  CLK_;
  ...
  buf B45(D_[14], D[14]);
  buf B46(D_[15], D[15]);
  buf B47(EMA_[0], EMA[0]);
  buf B48(EMA_[1], EMA[1]);
  buf B49(EMA_[2], EMA[2]);
  buf B50(RETN_, RETN);
