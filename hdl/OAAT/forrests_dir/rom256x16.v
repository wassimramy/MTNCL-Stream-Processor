...
//      Test Muxes                  Off
//
//      Creation Date:  Mon Dec 30 12:46:20 2019
//      Version: 	r0p0-00eac0
//
...
`celldefine
`ifdef POWER_PINS
module rom256x16 (Q, CLK, CEN, A, EMA, VSS, VDD);
`else
module rom256x16 (Q, CLK, CEN, A, EMA);
`endif
...
`endif
  ...
  initial begin
    $readmemb("/home/mtennant/Projects/GRNN_Questa/rom256x16_verilog.rcf", mem );
  end
...
`endif
 ...
 wire  CLK_;
  ...
  buf B24(A_[6], A[6]);
  buf B25(A_[7], A[7]);
  buf B26(EMA_[0], EMA[0]);
  buf B27(EMA_[1], EMA[1]);
  buf B28(EMA_[2], EMA[2]);
